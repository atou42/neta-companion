Create a single horizontal sprite strip for the Codex app digital pet `fm-silver-elf-mage` in the state `waving`.
...
Animation action: FM playing loop, the mage gently raises the tiny staff and sways with the beat, then returns.


State-specific requirements:
- Show music playback through pose only: staff low, staff raised, small shoulder sway, staff returning.
- Keep feet planted and make the motion feel like quiet rhythm, not a greeting.
- Do not draw music notes, wave marks, motion arcs, lines, sparkles, symbols, or floating effects around the staff.
- Preserve the canonical base look: silver-white hair, green eyes, pointed ears, white and gold robe, compact front-facing mage silhouette.
- Do not change the character into a different soft green-haired or round-eyed variant.
